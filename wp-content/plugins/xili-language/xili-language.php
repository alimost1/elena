...
*/
# updated 250320 - 2.21.3 - fixes sanitizing
# updated 160728 - 2.21.2 - verified with 4.5.3 and tested with 4.6-rc1
...
define('XILILANGUAGE_VER', '2.21.3'); /* used in admin UI*/
...
define('XILILANGUAGE_WP_TESTED', '4.8 Coleman Hawkins'); /* 2.17.1 - used in version pointer infos */
...
class xili_language {
	...
	function xili_test_lang_perma () {
		...
		$this->lang_perma = false;
		if ( class_exists ( 'XL_Permalinks_rules' ) && isset($XL_Permalinks_rules) && is_object( $XL_Permalinks_rules ) ) {
			if ( method_exists ( $XL_Permalinks_rules, 'insert_lang_tag_root') ) {
				$this->lang_perma = true;
			}
		}
		$this->lpr = "-"; // 2.16.6
	}
