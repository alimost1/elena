...
<div class="elena-page-content elena-section">
    <div class="elena-container">
        <header class="elena-archive-header">
            <?php the_archive_title( '<h1 class="elena-page-title">', '</h1>' ); ?>
            <?php the_archive_description( '<div class="elena-archive-desc">', '</div>' ); ?>
        </header>
