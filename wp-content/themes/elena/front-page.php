    ...
    <section class="elena-collection-intro elena-section" id="collection">
        <div class="elena-container">
            <div class="elena-collection-text elena-animate">
                <h2 class="elena-section-subtitle">Collection For Men</h2>
                <p>Discover our selection of performance athletic footwear. Each pair is designed to deliver maximum comfort and style for everyday wear.</p>
                <p>Engineered with premium materials, our sneakers blend cutting-edge technology with contemporary aesthetics.</p>
                <p>Every pair is crafted for those who demand more from their footwear — combining performance, durability, and style in equal measure.</p>
            </div>
        </div>
    </section>
    ...
    <section class="elena-best-sellers elena-section" id="best-sellers">
        <div class="elena-container">
            <div class="elena-section-header elena-animate">
                <h2 class="elena-section-title">Best Sellers</h2>
                <p class="elena-section-label">SNEAKERS COLLECTION</p>
            </div>
        ...
        <div class="elena-reviews-bg">
            <div class="elena-container">
                <div class="elena-reviews-content elena-animate">
                    <h2 class="elena-section-title elena-text-white">Reviews</h2>
                    <p class="elena-reviews-rating elena-text-white">Our customers consistently rate us <strong>4.8 / 5</strong></p>

                    <div class="elena-testimonials">
                        <div class="elena-testimonial">
                            <div class="elena-stars">★★★★★</div>
                            <p class="elena-testimonial-name"><strong>Amine</strong></p>
                            <p class="elena-testimonial-text">"The quality is outstanding. These are the best sneakers I've ever owned. Comfortable, stylish, and they last. Absolutely worth every dirham."</p>
                        </div>
                        <div class="elena-testimonial">
                            <div class="elena-stars">★★★★★</div>
                            <p class="elena-testimonial-name"><strong>Sara</strong></p>
                            <p class="elena-testimonial-text">"Got my order in just 2 days! Great quality materials and super comfortable. The customer service is incredible too — very responsive and professional."</p>
                        </div>
                    </div>
    ...
    <section class="elena-cta elena-section" id="cta">
        <div class="elena-container elena-cta-inner">
            ...
            <div class="elena-cta-text elena-animate">
                <h2 class="elena-cta-title">Buy Your<br>Sneakers<br>Today</h2>
