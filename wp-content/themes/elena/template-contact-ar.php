<?php
/**
 * Template Name: Contact Page Arabic
 *
 * @package Elena
 */
...
if (!$cf7_form) {
    $cf7_candidate = get_page_by_title('Contact AR', OBJECT, 'wpcf7_contact_form');
    if (!$cf7_candidate) {
...
?>
<div dir="rtl" class="masha-rtl-wrapper elena-contact-page elena-contact-ar elena-section">
    <div class="elena-container">

        <header class="elena-contact-hero">
            <span class="elena-contact-eyebrow">Elena.ma</span>
            <h1 class="elena-contact-title">تواصل معنا</h1>
            <p class="elena-contact-subtitle">
                هل لديك سؤال أو استفسار حول طلب؟ فريقنا في خدمتك من الإثنين إلى السبت، من الساعة 9 صباحاً إلى 6 مساءً.
            </p>
        </header>
        ...
        <div class="elena-contact-grid">
            ...
            <aside class="elena-contact-info">
                <div class="elena-contact-card">
                    ...
                    <div class="elena-contact-card-body">
                        ...
                        <a href="mailto:contact@elena.ma" dir="ltr">contact@elena.ma</a>
                        <p class="elena-contact-muted">نرد خلال 24 ساعة عمل</p>
                    </div>
                </div>
                ...
                <div class="elena-contact-card">
                    ...
                    <div class="elena-contact-card-body">
                        <h3>الهاتف</h3>
                        <a href="tel:+212687873820" dir="ltr">+212 687 87 38 20</a>
                        <p class="elena-contact-muted">الإثنين – السبت، 9 ص – 6 م</p>
                    </div>
                </div>
                ...
                <div class="elena-contact-card">
                    ...
                    <div class="elena-contact-card-body">
                        <h3>ساعات العمل</h3>
                        <p>الإثنين – السبت: 9 ص – 6 م</p>
                        <p class="elena-contact-muted">الأحد: مغلق</p>
                    </div>
                </div>
            ...
            <div class="elena-contact-form-wrap">
                <h2 class="elena-contact-form-title">أرسل لنا رسالة</h2>
                <p class="elena-contact-form-sub">املأ النموذج أدناه، وسنرد عليك في أقرب وقت ممكن.</p>
                <div class="elena-contact-form">
                    ...
                    if ($cf7_form) {
                        ...
                        echo 'لم يتم العثور على نموذج اتصال. قم بإنشاء نموذج من <strong>Contact → Contact Forms</strong>.';
                        echo '</p>';
                    }
                    ?>
                </div>
...
.elena-contact-subtitle { color: var(--elena-text-muted, #78716C); font-size: 1.05rem; line-height: 1.9; }
...
.elena-contact-card-body h3 { margin: 0 0 6px; font-size: 1rem; letter-spacing: .04em; color: var(--elena-text, #1C1917); }
...
.elena-contact-form input[type="submit"] {
    ...
    border-radius: 4px; transition: background .2s ease; font-size: .95rem;
}
