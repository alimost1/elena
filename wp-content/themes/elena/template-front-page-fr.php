...
if (false && function_exists('elementor_theme_do_location') && elementor_theme_do_location('single')) {
    ...
    <section class="elena-hero" id="hero">
        <div class="elena-hero-image-wrap">
            <img src="<?php echo esc_url($hero_bg); ?>" alt="<?php echo esc_attr($hero_title); ?>"
                class="elena-hero-bg-img">
        </div>
        ...
        <div class="elena-hero-cta">
            <a href="<?php echo esc_url($hero_cta_url ? $hero_cta_url : $shop_url); ?>"
                class="elena-btn elena-btn-primary elena-animate">
                        ...
                        <a href="<?php echo esc_url($shop_url); ?>" class="elena-category-card">
                            <div class="elena-category-image">
                                <div class="elena-product-placeholder">
                                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#bbb" stroke-width="1">
            ...
            if (class_exists('WooCommerce')) {
                ...
                if ($products->have_posts()) {
                    ...
                    if (!empty($filter_terms)) {
                        ...
                        echo '<li class="elena-favourites-filter-btn is-active" data-cat-filter="__all"><button type="button">' . esc_html__('Tous', 'elena') . '</button></li>';
                            ...
                            <div class="elena-product-card-inner">
                                <a href="<?php echo esc_url($shop_url); ?>" class="elena-product-link">
                                    <div class="elena-product-image">
                                        <div class="elena-product-placeholder">
                                            <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#bbb" stroke-width="1">
                                                <rect x="3" y="3" width="18" height="18" rx="2" />
                                                <circle cx="8.5" cy="8.5" r="1.5" />
                                                <path d="m21 15-5-5L5 21" />
                                            </svg>
                                ...
                                <div class="elena-product-info">
                                    ...
                                    <h3 class="elena-product-title"><a
                                            href="<?php echo esc_url($shop_url); ?>"><?php echo esc_html($demo['name']); ?></a></h3>
                                    <div class="elena-product-price"><?php echo esc_html($demo['price']); ?></div>
                                </div>
                                <div class="elena-product-actions">
                                    <a href="<?php echo esc_url($shop_url); ?>"
                                        class="button"><?php esc_html_e('Ajouter au panier', 'elena'); ?></a>
                                </div>
                            </div>
                        </li>
                        <?php
    ...
    <section class="masha-store-banner" id="store-banner"
        style="background-image: url('<?php echo esc_url(ELENA_URI . '/assets/images/store-interior.jpg'); ?>'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="masha-store-banner-overlay">
            <div class="elena-container">
                <p class="masha-store-banner-text"><?php esc_html_e('Découvrez Elena.ma, votre destination pour les meilleures offres exclusives en ligne et en boutique !', 'elena'); ?></p>
            </div>
        </div>
    </section>
        ...
        <div class="elena-reviews-bg">
            <div class="elena-container">
                <div class="elena-reviews-content elena-animate">
                    ...
                    <p class="elena-reviews-rating">
                        <?php printf(esc_html__('Nos clients nous évaluent systématiquement à %s', 'elena'), '<strong>4.8 / 5</strong>'); ?>
                    </p>

                    <div class="elena-testimonials">
                        <div class="elena-testimonial">
                            <div class="elena-stars">★★★★★</div>
                            <p class="elena-testimonial-name"><strong><?php esc_html_e('Amine B.', 'elena'); ?></strong>
                                <span class="elena-verified">✓ <?php esc_html_e('Achat vérifié', 'elena'); ?></span></p>
                            <p class="elena-testimonial-text">
                                "<?php esc_html_e('La qualité est exceptionnelle. Ce sont les meilleures chaussures que j\'aie jamais possédées. Confortables, élégantes et durables.', 'elena'); ?>"
                            </p>
                        </div>
                        <div class="elena-testimonial">
                            <div class="elena-stars">★★★★★</div>
                            <p class="elena-testimonial-name"><strong><?php esc_html_e('Sara M.', 'elena'); ?></strong>
                                <span class="elena-verified">✓ <?php esc_html_e('Achat vérifié', 'elena'); ?></span></p>
                            <p class="elena-testimonial-text">
                                "<?php esc_html_e('J\'ai reçu ma commande en seulement 2 jours ! Matériaux de grande qualité et super confortables. Service client incroyable.', 'elena'); ?>"
                            </p>
                        </div>
                        <div class="elena-testimonial">
                            <div class="elena-stars">★★★★★</div>
                            <p class="elena-testimonial-name"><strong><?php esc_html_e('Karim L.', 'elena'); ?></strong>
                                <span class="elena-verified">✓ <?php esc_html_e('Achat vérifié', 'elena'); ?></span></p>
                            <p class="elena-testimonial-text">
                                "<?php esc_html_e('Des chaussures qui allient parfaitement style et confort. Je recommande vivement Elena à tous mes amis.', 'elena'); ?>"
                            </p>
                        </div>
                    </div>
