...
<div id="page" class="elena-site masha-site">
	...
	<div class="masha-topbar">
		<div class="elena-container masha-topbar-inner">
			...
			<span class="masha-topbar-contact"><?php esc_html_e( 'Contactez-Nous:', 'mashaussure' ); ?> <?php echo esc_html( get_theme_mod( 'elena_footer_email', 'sav.machaussure@gmail.com' ) ); ?> | <?php echo esc_html( get_theme_mod( 'elena_footer_phone', '+212 687873820' ) ); ?></span>
		</div>
	</div>
	<?php endif; ?>
