    ...
    <section class="elena-best-sellers elena-section" id="best-sellers">
        <div class="elena-container">
            ...
            if ( class_exists( 'WooCommerce' ) ) {
                        ...
                        <li class="elena-product-card elena-product-card-masha">
                            <div class="elena-product-card-inner">
                                ...
                                <div class="elena-product-actions">
                                    <a href="<?php echo esc_url( $shop_url ); ?>" class="button"><?php esc_html_e( 'Ajouter au panier', 'mashaussure' ); ?></a>
                                </div>
                            </div>
                        </li>
                        <?php
                ...
                echo '<p class="elena-no-products">' . esc_html__( 'Installez WooCommerce pour afficher les produits ici.', 'mashaussure' ) . '</p>';
            }
            ?>
