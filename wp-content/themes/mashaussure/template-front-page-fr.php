 ...
 * Machaussure.ma Homepage – pixel-perfect replica
 *
 * @package Mashaussure
 */
            ...
            if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) {
                foreach ( $categories as $cat ) {
                    ...
                    if ( ! $thumb_url ) {
                        ...
                        elseif ( strpos($cat_n, 'mocassin') !== false || strpos($cat_n, 'bateau') !== false || strpos($cat_n, 'mule') !== false || strpos($cat_n, 'derbies') !== false ) $thumb_url = ELENA_URI . '/assets/images/categories/loafers.png';
        ...
        <div class="masha-benefits-row">
            <div class="masha-benefit-item">
                <div class="masha-benefit-icon">
                    <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14v10"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>
                </div>
            ...
            <div class="masha-benefit-item">
                <div class="masha-benefit-icon">
                    <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/><path d="M5 15h2"/><path d="M10 15h4"/></svg>
                </div>
            ...
            <div class="masha-benefit-item">
                <div class="masha-benefit-icon">
                    <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                </div>
